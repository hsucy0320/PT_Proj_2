...
- (void)drawRect:(CGRect)rect
{
    ...
    UIColor *grayColor = [UIColor colorWithRed:1 green:1 blue:1 alpha:0.8];
    [grayColor set];
    CGContextSetLineWidth(context, 2.0);    // no stroke
    CGRect ourRect = CGRectMake(2, 2, MIN(rect.size.width, rect.size.height)-4, MIN(rect.size.width, rect.size.height)-4);
    CGContextStrokeEllipseInRect(context, ourRect);
